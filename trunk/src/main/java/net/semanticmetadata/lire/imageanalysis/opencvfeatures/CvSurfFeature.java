...
public class CvSurfFeature implements Serializable, LireFeature {
    ...
    public CvSurfFeature(float ang, int cl, int o, double[] pt, float res, float s, double[] desc) {
        angle = ang;
        class_id = cl;
        octave = o;
        point = pt;
    ...
    public float getDistance(LireFeature f) {
        ...
        return (float) MetricsUtils.distL2(descriptor, ((CvSurfFeature) f).descriptor);
    }
